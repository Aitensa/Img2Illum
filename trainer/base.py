...
class BaseTrainer(pl.LightningModule):
    ...
    def training_epoch_end(self, step_outputs):
        ...
        # self.logger.log_metrics(metrics_mean,self.current_epoch)
        #self.logger.experiment.add_scalar("Train",
         #                                 metrics_mean,
          #                                self.global_step)
    ...
    def validation_epoch_end(self, step_loaders_outputs):
        for loader_outputs in step_loaders_outputs:
            ...
            self.logger.log_metrics(metrics_mean,self.global_step)
