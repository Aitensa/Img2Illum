...
def load_rgbd_as_tensor_pano(scene_id, color_image_name, downsample_rate):
    color_image = f'{matterport3d_root}'\
        + f'/{scene_id}' \
        + f'/undistorted_color_panorama' \
        + f'/{color_image_name}.jpg'

    depth_image_name = color_image_name
    depth_image = f'{matterport3d_root}'\
        + f'/{scene_id}' \
        + f'/undistorted_depth_panorama' \
...
def load_pred_rgbd_as_tensor(scene_id, color_image_name, downsample_rate):
    color_image = f'{matterport3d_root}'\
        + f'/{scene_id}' \
        + f'/undistorted_color_images' \
        + f'/{color_image_name}.jpg'
    ...
    depth_image = f'{matterport3d_root}'\
        + f'/{scene_id}' \
        + f'/undistorted_pred_depth_images' \
        + f'/{depth_image_name}.png'
